                    ...
                    try {
                        ...
                        const testPayload = {
                            data: [{
                                ...
                                event_source_url: 'https://perfect.appdetect.site/',
...
router.get('/api/admin/platform-comparison', authenticateToken, async (req, res) => {
    try {
        ...
        const ppDomains = `('perfect.appdetect.site')`;
        const mDomains = `('monetizze.appdetect.site', 'ingles.appdetect.site', 'espanhol.appdetect.site', 'ingles2.appdetect.site', 'espanhol2.appdetect.site')`;
