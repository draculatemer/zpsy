    ...
    try {
        ...
        if (funnelSource === 'perfectpay') {
            eventSourceUrl = funnelLanguage === 'es' 
                ? 'https://perfect.appdetect.site/espanhol/' 
                : funnelLanguage === 'pt'
                ? 'https://perfect.appdetect.site/portugues/'
                : funnelLanguage === 'fr'
                ? 'https://perfect.appdetect.site/frances/'
                : 'https://perfect.appdetect.site/ingles/';
...
router.all('/api/postback/perfectpay', async (req, res) => {
    ...
    try {
        ...
        // PerfectPay funnel is English by default (perfect.appdetect.site/ingles)
