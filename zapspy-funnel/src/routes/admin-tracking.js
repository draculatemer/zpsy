...
const CHECKOUT_LINKS = {
  en: {
    1: 'https://go.centerpag.com/PPU38CQAEMR', // $47
    2: 'https://go.centerpag.com/PPU38CQ9Q3O', // $37
    3: 'https://go.centerpag.com/PPU38CQAEMS', // $27
    4: 'https://go.centerpag.com/PPU38CQAEMT', // $17
  },
  es: {
    1: 'https://go.centerpag.com/PPU38CQAEMK', // $37
    2: 'https://go.centerpag.com/PPU38CQAEMJ', // $27
    3: 'https://go.centerpag.com/PPU38CQ9Q5C', // $17
    4: 'https://go.centerpag.com/PPU38CQA55R', // $9
  }
};
...
router.post('/api/admin/tracking/update-sender', authenticateToken, async (req, res) => {
  try {
    ...
    const editParams = {
      id: messageId,
      fromemail: fromEmail,
      fromname: fromName || msgData.fromname || 'Whats Spy',
      reply2: fromEmail,
      subject: msgData.subject,
